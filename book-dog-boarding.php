...
<head>
    ...
    <title>Book Dog Boarding</title>
    <link rel="stylesheet" href="style.css">
    <script defer src="script.js"></script>
</head>
<body>
    <header>
        <h1>Book Dog Boarding</h1>
    </header>
    <main>
        <form id="booking-form" action="submit-booking.php" method="POST">
            <input type="hidden" name="service_type" value="Dog Boarding">
